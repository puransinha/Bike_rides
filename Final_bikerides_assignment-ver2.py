...
def data_str():
    ...
    bikes=input('\n Do you like to continue .......: type - y / n :')
    if 'y' in bikes:
        print(bike.head(4))
        print(bike.shape)
        print(bike.describe())
        ...
        print(bike.dtypes) # Change datatype 'dteday' from object to date time
...
def eda():
    ...
    print('*********** Sucessfully Imported the data with removing irelevant Features**************')
    plot = input('Do you want to continue with Plotting the Graph : ')
    if 'y' in plot:
        plotting()
    else:
        pass
...
def plotting():
    ...
    plt.show()
    print (' ****** Sucessfully Plotted the Graph .... Continuing with data preperation ......')
    data_final = input('Do you want to continue with ML : ')
    if 'y' in data_final:
        data_prep()
